...
procToWord (Reflect Stop) = (unpack tag)
  where tag = (discriminatorW (Reflect Stop)) ++# 0
procToWord (Reflect (Input (Code px) (Code py) q)) = (unpack (tag ++# nx ++# ny ++# qx ++# 0))
